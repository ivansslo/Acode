...
async function EditorManager($header, $body) {
	...
	/**
	 * Optimized: Batches theme, editor options, and read-only status changes into a single
	 * editor.dispatch call to avoid redundant CodeMirror view update cycles.
	 * Reduces up to 17 dispatches to 1.
	 */
