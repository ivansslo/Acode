...
export class Mode {
	...
	/**
	 * Specificity score for sorting. Calculated once on creation.
	 */
	...
	constructor(
		...
		this.specificityScore = this.calculateSpecificityScore();
		let re = "";
	 ...
	 */
	private calculateSpecificityScore(): number {
		const extensionsStr = this.extensions;
		let maxScore = 0;
