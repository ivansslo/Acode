...
// static constant mapping of filename match types to patterns to avoid re-allocation
const fileTypeRegex = {
	babel: /\.babelrc$/i,
	jsmap: /\.js\.map$/i,
	yarn: /^yarn\.lock$/i,
...
function getFileType(filename) {
	// Use allocation-free for...in loop to avoid creating arrays of keys on every execution
